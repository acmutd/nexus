...
const Home = () => {
  ...
  return (
    <div className={` min-h-screen flex items-center justify-center bg-blue-950 bg-cover bg-center bg-fixed overflow-hidden`} 
                style={{ backgroundImage: "url('/assets/HomeBG.svg')", fontFamily: "titilliumWeb-semibold" }}
                >
      ...
      <motion.div className="flex flex-col w-full h-full items-center justify-center mt-30 z-1" initial={{opacity:0, y:20}} animate={{opacity: 1, y:0}} transition={{duration: 0.7}}>
        ...
        <div className='bg-nexus800 rounded-full flex px-4 items-center gap-2 justify-center font-titilliumWeb-semibold p-1 mt-2 text-nexus100 mb-8'>
