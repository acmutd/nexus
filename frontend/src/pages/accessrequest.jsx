      ...
      style={{ backgroundImage: isMed ? "url('/assets/AccessRequestBGLong.svg')" : "url('/assets/AccessRequestBG.svg')" }}>
        ...
        <div className="flex flex-col w-2/5 scale-90 bg-gradient-to-b from-nexus100 from-10% to-white to-90% rounded-xl p-6" style={{ zIndex: 2 }}>
          ...
          <div className="items-center justify-center flex flex-col" style={{ marginTop: isMed ? -8 : 0, scale: isMed ? .8 : 1 }}>
            ...
            <h2 className="font-titilliumWeb-regular text-nexus800 text-center text-2xl">
          ...
          <div className="flex flex-col bg-nexus50 rounded-xl items-center text-center justify-center" style={{ marginTop: isMed ? -8 : 16 }}>
            <h1 className="font-titilliumWeb-bold text-nexus800 text-3xl pt-4" style={{ fontSize: isMed ? 25 : 30 }}>
