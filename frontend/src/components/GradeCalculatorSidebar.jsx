          ...
          >
            <div className="flex-1">
              ...
              <div className="mb-6">
                <div className="relative">
                  ...
                  >
                  <button 
                      className="flex items-center p-3 rounded-full relative group text-nexus-blue-200 hover:text-white"
                      title="Grade History"
                    >
                    ...
                    {isDropdownOpen ? <HiChevronUp className="text-nexus-blue-200 hover:text-white" /> : <HiChevronDown className="text-nexus-blue-200 hover:text-white" />}
                  </button>
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      <motion.div
                        ...
                        className="mt-1 bg-nexus-blue-600 rounded border border-nexus-blue-600 overflow-hidden text-white"
                      >
                        {coursesToUse.length > 0 ? (
                          coursesToUse.map((course, index) => (
                            <button
                              ...
                              className="w-full text-left px-3 py-2 text-sm text-white hover:bg-nexus-blue-700 hover:text-white transition-colors duration-200"
                            >
                              {course.displayName}
                            </button>
                          ))
            ...
            <div className="mt-auto pb-4">
              <button 
                ...
                className="flex items-center justify-center w-full p-3 rounded-lg bg-nexus-blue-600 hover:bg-nexus-blue-500 text-white font-semibold transition-colors duration-200"
              >
