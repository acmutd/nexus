...
import { HiAcademicCap, HiCalculator, HiChat, HiUserCircle, HiDocumentText, HiLogout } from 'react-icons/hi';
...
const Navbar = () => {
  ...
  const buttonClasses = `font-bold py-2 px-3 rounded flex items-center ${
    isScrolled
